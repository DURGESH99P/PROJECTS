...
pygame.init()
pygame.display.set_caption("Snake Game by:- Gaurav, Hrishikesh and Durgesh")
pygame.font.init()
random.seed()
...
score_msg = score_font.render("Score : ",1,pygame.Color("green")) #render(text, antialias, color, background=None) -> Surface
# This render function is used to creates a new Surface with the specified text rendered on it. pygame provides 
# no way to directly draw text on an existing Surface: instead you must use Font.render() to create an image (Surface) of the text, 
...
# adding banner of the one's who typed this code

# name = pygame.font.Font("Hrishikesh", 40)
# def bannerName(name):
#     name = name.render("Hrishikesh", )
# myfont = pygame.font.SysFont("monospace", 15)

# # render text
# label = myfont.render("Game by - Hrishikesh, Gaurav & Durgesh", 1, (255,255,0))
# screen.blit(label, (100, 100))
def banner():
    my_font = pygame.font.Font(None, 30)
    text_surface = my_font.render("Group Project Made by Hrishikesh, Gaurav & Durgesh", 1, (207, 48, 17))
    screen.blit(text_surface,(SCREEN_WIDTH - 10,10))
